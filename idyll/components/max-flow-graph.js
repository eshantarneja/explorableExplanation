...
update(props, oldProps) {
    ...
    // simple example
      ...
      // this.notMaxFlow (props, oldProps)
      // this.maxFlow (props, oldProps)
      this.capExceeded (props, oldProps)
  ...
  capExceeded(props, oldProps){
    ...
    .transition()
    .delay(t2)
    .text("ERROR: CAPACITY EXCEEDED")
    .style('fill', 'red')
  }

   notMaxFlow(props, oldProps){
    var t1 = 1000;
    var t2 = 2000;
    var t3 = 3000;
    var t4 = 4000;
